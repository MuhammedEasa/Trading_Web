                    ...
                    <div className="flex flex-col items-start gap-4">
                        ...
                        <AnimationContainer animation="fadeUp" delay={0.4}>
                            <h1 className="text-5xl lg:text-6xl font-medium !leading-tight text-transparent bg-clip-text bg-gradient-to-r from-foreground to-neutral-500">
                                Trade Smarter with Cara Markets
                            </h1>
                        </AnimationContainer>

                        <AnimationContainer animation="fadeUp" delay={0.6}>
                            <p className="text-sm md:text-base lg:text-lg text-muted-foreground">
                                Unlock global markets with a secure and reliable trading platform. Cara Markets offers 2000+ CFD instruments, expert support, and innovative tools for traders at every level.
                            </p>
                        </AnimationContainer>
                    </div>
